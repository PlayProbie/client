    ...
    async ({ params: _params }) => {
      ...
      const question1 = {
        ...
        result_json: JSON.stringify({
          ...
          answer_profiles: {
            ...
            out1: { age_group: '30s', gender: 'M', prefer_genre: 'RPG' },
            out2: { age_group: '20s', gender: 'F', prefer_genre: 'RPG' },
            out3: { age_group: '20s', gender: 'M', prefer_genre: 'FPS' },
          },
          sentiment: {
            score: 68,
            label: '긍정적',
      ...
      const question3 = {
        ...
        result_json: JSON.stringify({
          ...
          answer_profiles: {
            ans13: { age_group: '20s', gender: 'M', prefer_genre: 'RPG' },
            ans14: { age_group: '20s', gender: 'F', prefer_genre: 'FPS' },
            ans15: { age_group: '10s', gender: 'M', prefer_genre: 'Action' },
            ans16: { age_group: '30s', gender: 'M', prefer_genre: 'RPG' },
            out6: { age_group: '40s', gender: 'F', prefer_genre: 'Puzzle' },
            out7: { age_group: '20s', gender: 'M', prefer_genre: 'Sports' },
          },
          sentiment: {
            score: 85,
            label: '매우 긍정적',
